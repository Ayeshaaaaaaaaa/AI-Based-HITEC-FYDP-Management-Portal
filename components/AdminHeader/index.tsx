      ...
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-60 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-dark-3 dark:bg-dark-2 lg:hidden"
          >
          ...
          <Link className="block flex-shrink-0 lg:hidden" href="/superadmin">
            <Image
              width={40}
              height={40}
        ...
        <div className="hidden xl:block">
          <div>
            ...
            <p className="font-small dark:text-white">ProjectSphere - Innovative Portal for FYP Management</p>
          </div>
        </div>
