...
>
    ...
    <option value="student" className="border-stroke dark:text-body-color-dark dark:shadow-two mb-6 flex w-full items-center justify-center rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary dark:hover:shadow-none">Student</option>
    <option value="faculty" className="border-stroke dark:text-body-color-dark dark:shadow-two mb-6 flex w-full items-center justify-center rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary dark:hover:shadow-none">Faculty</option>
</select>

                                {userType === 'student' && (
                                    <>
                                    const regex = /^(\d{2})-([A-Z]{2})-(\d{3})@student\.hitecuni\.edu\.pk$/;
                                    const match = email.match(regex);

                                    if (match) {
                                        // const year = match[1]; // Extract year (e.g., 21)
                                        // const department = match[2]; // Extract department (e.g., SE)
                                        // const rollNumber = match[3]; // Extract roll number (e.g., 039)
